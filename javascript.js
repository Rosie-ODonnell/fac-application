...
function languageClick() {
    ...
    english[24]["innerText"] = "\n Una pasión por mejorar. Estoy lista para usar mis fortalezas para ayudar a mis compañeros y aprender de ellos en áreas donde necesito mejorar (... como aprender a hacer que un botón flotante funcione sobre una cuadrícula secundaria). De esa manera, construiremos un conjunto completo de habilidades preparadas para la industria juntos.";
    ...
    if (buttonText == "EN") {
        ...
        english[24]["innerText"] = "\n A passion to improve. I am ready to use my strengths to help my peers and to learn from them in areas where I need to improve (...such as learning how to make a floating button work over a child grid). That way, we will build a full set of industry-ready skills together. ";
